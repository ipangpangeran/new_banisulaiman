...
<div class="header">
    <div class="inner-header flex">
        <h1 class="font-judul mt-3">Kegiatan Harian</h1>
    </div>
    <!--Waves Container-->
    <div>
   ...
   <div class="container pb-5">
      ...
      <div class="row align-items-center">
         <div class="col-md-6 d-flex align-items-center">
            <div>
               <h3 class="font-weight-bold mb-3">Jadwal Sholat Berjama'ah</h3>
               <p>
         ...
         <div class="col-md-4 mx-auto my-4">
            <div class="dg-image_box">
               <img src="<?php echo IMAGE_PATH?>jadwal-shalat.png" alt="wave" class=" w-100 dg_images">
            </div>
         </div>

         <div class="col-md-4 mx-auto my-4">
            <div class="dg-image_box">
               <img src="<?php echo IMAGE_PATH?>kajian.jpg" alt="wave" class=" w-100 dg_images">
            </div>
         </div>

         <div class="col-md-6 my-4 d-flex align-items-center">
            <div>
               <h3 class="font-weight-bold mb-3">Kajian Rutin</h3>
               <p>
                  Lorem ipsum odor amet, consectetuer adipiscing elit.
               </p>
            </div>
