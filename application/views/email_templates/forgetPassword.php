                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="left" style="padding: 55px 90px 0px 90px;">
                                                    <img src="<?php echo IMAGE_PATH?>Logo.png" height="auto" alt="logo" width="145" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table bgcolor="#FFFFFF" style="background-color: #FFFFFF;margin: 0;" class="col-700"
                                        ...
                                        <tr align="left">
                                            <td style="padding: 0 90px 40px 90px" align="left" width="100%">
                                                ...
                                                <p class="text-color">
                                                   Best Regards, <br>
                                                  <a href="<?php echo base_url()?>" style="color: #505050;text-decoration: none;"> www.StrategiLingkarNusantara.com</a>
                                                </p>
                                                <p style="color: #0000ff; text-decoration: underline;">
