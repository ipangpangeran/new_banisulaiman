...
class Ion_auth_model extends CI_Model
{
	...
	public function update_group($group_id = FALSE, $group_name = FALSE, $additional_data = array())
	{
		...
		// restrict change of name of the users group
	...
	/**
	 * Generates a random key and returns
	 * @return string
	 */
	private function _generate_token()
	{
		...
		} // Already in the DB? hash. Try again
		while (self::_token_exists($new_key));
	...
	{
		return $this->db->where('auth_token', $auth_token)->count_all_results('users');
	}
