...
abstract class REST_Controller extends \CI_Controller {
    ...
    {
        // Check to see if PHP is equal to or greater than 7.2.x
        if (is_php('5.4') === FALSE)
        {
            // CodeIgniter 3 is recommended for v7.2 or above
            throw new Exception('Using PHP v'.PHP_VERSION.', though PHP v7.2 or greater is required');
        }
